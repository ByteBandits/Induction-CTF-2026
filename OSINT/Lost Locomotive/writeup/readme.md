...
Looking closely, there is also a parked train with the number **500** visible on the front. This becomes an important clue.
...
Reading the coordinates of that spot and rounding to two decimal places gives:

## 🏁 Flag

**`BBCTF{ollantaytambo_-13.26_-72.27}`**
